 **Deprecated**  
This project is no longer maintained and has been **deprecated** in favor of [RHDP Default Showroom theme](https://github.com/rhpds/rhdp_showroom_theme).  
Please consider migrating to the new repository for the latest updates, features, and support.

= Red Hat Demo Platform UI Bundle
// Settings:
:experimental:
:hide-uri-scheme:
// Project URLs:
:url-project: https://github.com/rhpds/showroom_theme_rhdp
:url-preview: https://rhpds.github.io/showroom_theme_rhdp
// External URLs:
